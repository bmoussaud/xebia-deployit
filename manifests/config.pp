...
class deployit::config (
  ...
  ini_setting {
    ...
    'deployit.http.bind.address':        setting => 'http.bind.address',        value => $http_bind_address;
    'deployit.http.context.root':        setting => 'http.context.root',        value => $http_context_root;
    'deployit.importable.packages.path': setting => 'importable.packages.path', value => $importable_packages_path;
  }
